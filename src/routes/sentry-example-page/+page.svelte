	...
	<main>
		...
		<p class="description">
			Click the button below, and view the sample error on the Sentry <a
				target="_blank"
				href="https://jloh.sentry.io/issues/?project=4510401557823488">Issues Page</a
		...
		<button type="button" onclick={getSentryData} disabled={!isConnected}>
			<span> Throw Sample Error </span>
		</button>

		{#if hasSentError}
			<p class="success">Sample error was sent to Sentry.</p>
		{:else if !isConnected}
