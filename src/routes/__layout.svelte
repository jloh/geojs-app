...
<div class="mb-6 border-b-2 bg-white">
	<nav id="header" class="mx-auto max-w-6xl py-2 px-4">
		<div class="mx-auto mb-2 flex flex-wrap">
			<div
				class="mt-2 flex flex-1 items-baseline justify-center text-lg font-medium text-gray-800 transition-all sm:justify-start sm:text-left md:w-auto md:font-normal"
			>
				<a title="Home" href="/"
				...
				>
				<a class="ml-3 hover:text-blue-500" title="Home" href="https://jloh.co/tag/geojs/">Blog</a>
			</div>
			<div
			...
			>
				<div
					class="text-md my-2 flex flex-1 items-baseline justify-center text-gray-800 sm:justify-end md:mb-0"
				>
